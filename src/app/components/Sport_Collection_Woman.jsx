...
const images = [
  { className: 'bg-Sport_Woman-1', text: 'T-SHIRT', description: 'Comfortable and stylish.' },
  { className: 'bg-Sport_Woman-2', text: 'LITE JACKET', description: 'Lightweight and versatile.' },
  { className: 'bg-Sport_Woman-3', text: 'POLO', description: 'Classic and breathable.' },
];
